...
const AddFood = () => {
  ...
  return (
    <div className="add-food">
      <h1 className="food-head">Add New Food Donation</h1>
      <form onSubmit={addFoodForm} className="add-food-form">
        ...
        <button type="submit" disabled={loading} className="add-food-button">
